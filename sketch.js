...
function preload() {
  ...
  endlineImage = loadImage("Sprite/earth.gif");
...
function draw() {
  ...
  if(gameState === play) {
    ...
    text("target : 50" , canvas.width/2,60);
...
spaceShip.y = 600;
  ...
  if(gameState === instruction) {
    ...
    text(".....Space Marvels....",490,canvas.height/2-400);
...
function asteroids() {
  ...
  function asteroids() {
    if(frameCount % 200 === 0) {
      ...
      bigasteroid.scale = random(0.7,0.9);
      //asteroid.debug = true;
